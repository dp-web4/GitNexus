...
Indexed as **GitNexus** (2184 symbols, 5245 relationships, 167 execution flows). MCP tools available via `mcp__gitnexus__*`.
...
Resources: `gitnexus://repo/GitNexus/context`, `clusters`, `processes`, `process/{name}`
<!-- gitnexus:end -->
